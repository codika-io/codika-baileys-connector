...
echo -e "${GREEN}  ==========================================${NC}"
echo ""
echo -e "  ${BOLD}Open this URL in your browser to link WhatsApp:${NC}"
echo ""
...
echo "  2. Choose your connection method: QR Code or Pairing Code"
echo "  3. Open WhatsApp on your phone > Settings > Linked Devices > Link a Device"
echo "  4. Scan the QR code, or tap 'Link with phone number instead' and enter the pairing code"
echo ""
